...
class saidaestoqueModel extends model {
    ...
    public function getMovimento($where = null) {
        ...
        $tables .= ' left join prodCliente as m on m.idCliente = a.idCliente';
        return $this->read($tables, array('a.*', 'd.dsTipoMovimento', 'm.dsCliente'), $where, null, null, null, null);
    }
    ...
    public function getMovimentoItens($where = null) {
        ...
        return $this->read($tables, array('a.*', 'd.dsInsumo', 'm.dsGrupo', 'd.vlUltimaCompra as vlUnitario'), $where, null, null, null, $orderby);
    }
