                    ...
                    <div class="col-xs-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="idMotivo" id="idMotivo">
                                {html_options options=$lista_motivo}
                            </select>                      
                        </div>
                    </div>                     
                    <div class="col-xs-9">
                        <label for="form-control">Analise da Causa</label>
                        <textarea type="text" class="form-control" name="dsAnaliseCausa" id="dsAnaliseCausa" > {$registro.dsAnaliseCausa|default:''} </textarea>
                    </div> 
                </div>
                <br>
                <div class="row">
                    <div class="col-xs-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="idStatusOS" id="idStatusOS" >
                                {html_options options=$lista_statusOS}
                            </select>                      
                        </div>
                    </div> 
                    <div class="col-xs-2">
