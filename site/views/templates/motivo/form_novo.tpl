    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idMotivo}>0} {$registro.dsMotivo|default:''}{else} Inclus&atilde;o de Motivos{/if}</h1></tt>
            </div>          
            ...
            <form name="frm-motivo" 
                ...
                <div class="input-group col-lg-8">                    
                    {if {$registro.idMotivo}>0}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                            <input type="text" class="form-control" name="idMotivo" id="idMotivo" value="{$registro.idMotivo}" READONLY>           
                    {else}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsMotivo|default:''}" >           
                </div> 
                <br>            
