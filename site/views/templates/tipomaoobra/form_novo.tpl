    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idTipoMaoObra}>0} {$registro.dsTipoMaoObra|default:''}{else} Inclus&atilde;o de Tipos de Mão de Obra{/if}</h1></tt>
            </div>          
            ...
            <form name="frm-tipomaoobra" 
                ...
                <div class="input-group col-lg-8">                    
                    {if {$registro.idTipoMaoObra}>0}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                            <input type="text" class="form-control" name="idTipoMaoObra" id="idTipoMaoObra" value="{$registro.idTipoMaoObra}" READONLY>           
                    {else}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsTipoMaoObra|default:''}" >           
                </div> 
                <br>            
