    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idTipoCliente}>0} {$registro.dsTipoCliente|default:''} {else} Inclus&atilde;o de Tipos de Clientes {/if}</h1></tt>
            </div>          
            ...
            <form name="frm-tipocliente" 
                ...
                <div class="input-group col-lg-8">                    
                    {if {$registro.idTipoCliente}>0}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                            <input type="text" class="form-control" name="idTipoCliente" id="idTipoCliente" value="{$registro.idTipoCliente}" READONLY>           
                    {else}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsTipoCliente|default:''}" >           
                </div> 
                <br>            
