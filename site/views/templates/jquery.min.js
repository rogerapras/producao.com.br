        ...
        f[c] = function(a, d, e, g) {
            ...
            function w(a, c, l, m) {
                if (s !== 2) {
                    ...
                    v.stStatus = a, v.stStatusText = "" + (c || w), o ? h.resolveWith(e, [r, w, v]) : h.rejectWith(e, [v, w, u]), v.stStatusCode(j), j = b, t && g.trigger("ajax" + (o ? "Success" : "Error"), [v, d, o ? r : u]), i.fireWith(e, [v, w]), t && (g.trigger("ajaxComplete", [v, d]), --f.active || f.event.trigger("ajaxStop"))
                }
            }
            typeof a == "object" && (c = a, a = b), c = c || {};
            var d = f.ajaxSetup({}, c), e = d.context || d, g = e !== d && (e.nodeType || e instanceof f) ? f(e) : f.event, h = f.Deferred(), i = f.Callbacks("once memory"), j = d.stStatusCode || {}, k, l = {}, m = {}, n, o, p, q, r, s = 0, t, u, v = {readyState: 0, setRequestHeader: function(a, b) {
                    if (!s) {
                        var c = a.toLowerCase();
                        a = m[c] = m[c] || a, l[a] = b
                    }
            ...
            h.promise(v), v.success = v.done, v.error = v.fail, v.complete = i.add, v.stStatusCode = function(a) {
                if (a) {
                    var b;
                    if (s < 2)
                        for (b in a)
                        ...
                        try {
                            if (d && (e || h.readyState === 4)) {
                                ...
                                if (e)
                                    ...
                                    j = h.stStatus, l = h.getAllResponseHeaders(), m = {}, n = h.responseXML, n && n.documentElement && (m.xml = n);
                                    try {
