    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idInsumo}>0} {$registro.dsInsumo|default:''}{else} Inclus&atilde;o de Insumos{/if}</h1></tt>
            </div>          
            ...
            <form name="frm-insumo" 
                ...
                <div class="row">
                    ...
                    <div class="col-xs-3">
                        ...
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsInsumo|default:''}" >           
                    </div> 
                    <div class="col-xs-1">
