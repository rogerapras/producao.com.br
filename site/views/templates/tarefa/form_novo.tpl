    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idTarefa}>0} {$registro.dsTarefa|default:''}{else} Inclus&atilde;o de Tarefas{/if}</h1></tt>
            </div>          
            ...
            <form name="frm-tarefa" 
                ...
                <div class="input-group col-lg-8">                    
                    {if {$registro.idTarefa}>0}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                            <input type="text" class="form-control" name="idTarefa" id="idTarefa" value="{$registro.idTarefa}" READONLY>           
                    {else}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsTarefa|default:''}" >           
                </div> 
                <br>            
