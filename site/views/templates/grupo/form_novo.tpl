    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idGrupo}>0} {$registro.dsGrupo|default:''}{else} Inclus&atilde;o de Grupos{/if}</h1></tt>
            </div>          
            ...
            <form name="frm-grupo" 
                ...
                <div class="input-group col-lg-8">                    
                    {if {$registro.idGrupo}>0}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                            <input type="text" class="form-control" name="idGrupo" id="idGrupo" value="{$registro.idGrupo}" READONLY>           
                    {else}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsGrupo|default:''}" >           
                </div> 
                <br>            
