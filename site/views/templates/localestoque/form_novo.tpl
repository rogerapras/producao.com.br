    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idLocalEstoque}>0} {$registro.dsLocalEstoque|default:''}{else} Inclus&atilde;o de Local de Estoques{/if}</h1></tt>
            </div>          
            ...
            <form name="frm-localestoque" 
                ...
                <div class="input-group col-lg-8">                    
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsLocalEstoque|default:''}" >           
                </div> 
                <br>            
