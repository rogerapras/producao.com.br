    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idMotivoBaixa}>0} {$registro.dsMotivoBaixa|default:''}{else} Inclus&atilde;o de Motivos de Baixa {/if}</h1></tt>
            </div>          
            ...
            <form name="frm-motivobaixa" 
                ...
                <div class="input-group col-lg-8">                    
                    {if {$registro.idMotivoBaixa}>0}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                            <input type="text" class="form-control" name="idMotivoBaixa" id="idMotivoBaixa" value="{$registro.idMotivoBaixa}" READONLY>           
                    {else}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsMotivoBaixa|default:''}" >           
                </div> 
                <br>            
