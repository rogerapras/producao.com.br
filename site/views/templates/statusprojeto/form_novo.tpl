    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idStatusProjeto}>0} {$registro.dsStatusProjeto|default:''}{else} Inclus&atilde;o de Status de Projetos{/if}</h1></tt>
            </div>          
            ...
            <form name="frm-statusprojeto" 
                ...
                <div class="input-group col-lg-8">                    
                    {if {$registro.idStatusProjeto}>0}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                            <input type="text" class="form-control" name="idStatusProjeto" id="idStatusProjeto" value="{$registro.idStatusProjeto}" READONLY>           
                    {else}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsStatusProjeto|default:''}" >           
                </div> 
                <br>            
