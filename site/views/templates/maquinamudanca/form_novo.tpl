    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idMaquina}>0} {$registro.dsMaquina|default:''}{else} Mudança do Status da Maquina{/if}</h1></tt>
            </div>          
                    ...
                    <div class="col-xs-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="idStatusMaquina" id="idStatusMaquina" >
                                {html_options options=$lista_status selected=$registro.idStatusMaquina}
                            </select>                      
                        </div>
                    </div> 
                    <div class="col-xs-5">
