    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            <div class="alert alert-info" >
                <tt><h1>{if {$registro.idMaquinaParada}>0} {$registro.dsMaquinaParada|default:''}{else} Inclus&atilde;o de Motivo de Máquina Parada {/if}</h1></tt>
            </div>          
            ...
            <form name="frm-maquinaparada" 
                ...
                <div class="input-group col-lg-8">                    
                    {if {$registro.idMaquinaParada}>0}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                            <input type="text" class="form-control" name="idMaquinaParada" id="idMaquinaParada" value="{$registro.idMaquinaParada}" READONLY>           
                    {else}
                        <span class="input-group-addon btn-outline btn-primary">Código</span>
                    ...
                    <span class="input-group-addon btn-outline btn-primary">Descri&ccedil;&atilde;o</span>
                        <input type="text" class="form-control" name="descricao" id="descricao" value="{$registro.dsMaquinaParada|default:''}" >           
                </div> 
                <br>            
