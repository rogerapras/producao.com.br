...
class paginadorPHP {
    ...
    public function gerar() {
        ...
        $_SESSION["paginacao"]["total_paginas"] = ceil($_SESSION["paginacao"]["total_registros"] / $_SESSION["paginacao"]["limite"]);
        ...
        $_SESSION["paginacao"]["botoes"]["primeiro"] = "<a href='" . $_SESSION["paginacao"]["url"] . "/pagina/1'>Primeira Página</a>";
            $_SESSION["paginacao"]["botoes"]["ultimo"] = "<a href='" . $_SESSION["paginacao"]["url"] . "/pagina/" . $_SESSION["paginacao"]["total_paginas"] . "'>Última Página</a>";
