<?php /* Smarty version Smarty-3.1.18, created on 2016-04-29 12:36:01
         compiled from "/var/www/html/producao.com.br/public/views/templates/osanalise/form_novo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22815243657237f61064290-43183051%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6ba23a9ba18df8474c70667cf82eb9c54b8d746b' => 
    array (
      0 => '/var/www/html/producao.com.br/public/views/templates/osanalise/form_novo.tpl',
      1 => 1457888031,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22815243657237f61064290-43183051',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57237f6112a3e4_60188442',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57237f6112a3e4_60188442')) {function content_57237f6112a3e4_60188442($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/producao.com.br/git/site/system/libs/smarty/plugins/modifier.date_format.php';
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="panel-body">
            ...
            <form name="frm-grava-os" action="/osanalise/gravar_os" method="POST" enctype="multipart/form-data">
                <br>
...
" >           
                ...
                <br>
                <div class="row" >
                    <h3> &nbsp; Informe a analise da causa:</h3>
                    <br>
                </div>
                <div class="row">
                    <div class="col-xs-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="idMotivo" id="idMotivo">
                                <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['lista_motivo']->value),$_smarty_tpl);?>
                    ...
                    <div class="col-xs-9">
                        ...
                        <textarea type="text" class="form-control" name="dsAnaliseCausa" id="dsAnaliseCausa" > <?php echo (($tmp = @$_smarty_tpl->tpl_vars['registro']->value['dsAnaliseCausa'])===null||$tmp==='' ? '' : $tmp);?>
 </textarea>
                    </div> 
                </div>
                <br>
                <div class="row">
                    <div class="col-xs-3">
                        <div class="form-group">
                            <label for="statusos">Escolha o novo Status para a Ordem de Serviço</label>
                            <select class="form-control" name="idStatusOS" id="idStatusOS" >
                                <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['lista_statusOS']->value),$_smarty_tpl);?>
...
<script src="/files/js/osanalise/analiseos.js"></script>
