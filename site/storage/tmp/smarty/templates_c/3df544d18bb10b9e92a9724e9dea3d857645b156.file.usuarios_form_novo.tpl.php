<?php /* Smarty version Smarty-3.1.18, created on 2016-04-29 12:54:06
         compiled from "/var/www/html/producao.com.br/public/views/templates/usuarios/usuarios_form_novo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2187726815723839e712b49-25029341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3df544d18bb10b9e92a9724e9dea3d857645b156' => 
    array (
      0 => '/var/www/html/producao.com.br/public/views/templates/usuarios/usuarios_form_novo.tpl',
      1 => 1453505537,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2187726815723839e712b49-25029341',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5723839e7b4113_73630574',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5723839e7b4113_73630574')) {function content_5723839e7b4113_73630574($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/var/www/html/producao.com.br/git/site/system/libs/smarty/plugins/function.html_options.php';
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="alert alert-info" >
            <h1><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['registro']->value['idUsuario'];?>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="dsUsuario" id="nome" value="<?php echo $_smarty_tpl->tpl_vars['registro']->value['dsUsuario'];?>
" />
                        </div>
                    </div>
                    <div class="col-xs-3">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="idUsuarioPerfil" id="idUsuarioPerfil"value="<?php echo $_smarty_tpl->tpl_vars['registro']->value['idUsuario'];?>
" />
                                </div>
                            </div>
                        </div>
...
if ($_smarty_tpl->tpl_vars['linha']->value['stStatus'] = 1) {?> Ativo <?php } else { ?> Inativo <?php }?></td>                        
