...
//die("chegou");
        ...
        $this->smarty->display('maquina/lista.html');
    }
...
//Funcao de Busca
    ...
    public function novo_maquina() {
        ...
        $this->smarty->display('maquina/form_novo.tpl');
    }
    ...
    public function relatoriomaquina_pre() {
        ...
        $this->smarty->display('maquina/relatorio_pre.html');
    }
    ...
    public function relatoriomaquina() {
        ...
        $this->smarty->display('maquina/relatorio.html');
    }
